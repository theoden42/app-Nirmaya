...
public class DataAdapterBMI extends PagerAdapter {
    private Context context;
    private ArrayList<DataHolderBMI> arrayList;

    public DataAdapterBMI(Context context, ArrayList<DataHolderBMI> arrayList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(pos == 3){
                    Intent intent =  new Intent(context, Calorie_Teller.class);
                    context.startActivity(intent);
                }
                if(pos == 4){
